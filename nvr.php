                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="db.php?aprreporter=<?php echo $row['uid']; ?>"
                                        class="btn btn-success btn-sm">
                                        <i class="fa fa-check"></i>
                                        Approve
                                    </a>

                                    <a href="db.php?delreporter=<?php echo $row['uid']; ?>"
                                        class="btn btn-danger btn-sm"
                                        onclick="return confirm('Delete this reporter?')">
                        ...
                        ?>
                            ...
                            <tr>
                                <td colspan="6" class="text-center text-danger font-weight-bold">
                                    No Non Verified Reporters Found
                                </td>
                            </tr>
