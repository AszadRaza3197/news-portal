...
if (!isset($_SESSION['uid']) || empty($_SESSION['uid']) || $_SESSION['role'] !== 'reporter') {
...
if (isset($_GET['memindex'])) {
    ...
    $page = 'profile';
} elseif (isset($_GET['unews'])) {
    $page = 'unews';
} elseif (isset($_GET['myn'])) {
    $page = 'myn';
...
<head>
    <meta charset="utf-8">
    <title>BizNews - Reporter Panel</title>
...
<body>
    ...
    <div class="container-fluid bg-light border-bottom d-none d-lg-block">
        <div class="row align-items-center py-2 px-lg-5">
            <div class="col-lg-12">
                <h1 class="m-0 h4 font-weight-bold text-dark">REPORTER <span class="text-primary h6 font-weight-normal">| Panel</span></h1>
            </div>
        </div>
    </div>
    <!-- Topbar End -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top shadow-sm py-1">
        <div class="container-fluid px-lg-4">
            ...
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#reporterNavbar" aria-controls="reporterNavbar" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>

            <!-- Navbar Content -->
            <div class="collapse navbar-collapse justify-content-between" id="reporterNavbar">
            ...
            <?php echo in_array($page, ['unews', 'myn']) ? 'active' : ''; ?>"
                            href="#"
                            id="newsDropdown"
                            role="button"
                        ...
                        <div class="dropdown-menu rounded-0 border-0 shadow"
                            ...
                            <!-- Upload News -->
                            <a href="db.php?unews"
                                class="dropdown-item <?php echo ($page == 'unews') ? 'active' : ''; ?>">
                                Upload News
                            </a>

                            <!-- My News -->
                            <a href="db.php?myn"
                                class="dropdown-item <?php echo ($page == 'myn') ? 'active' : ''; ?>">
                                My News
                            </a>
